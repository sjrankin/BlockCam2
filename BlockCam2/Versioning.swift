...
public class Versioning: CustomStringConvertible
{
    ...
    public static let MajorVersion: String = "2"
    ...
    public static let ApplicationName = "BlockCam2"
    
    /// Tag for the application.
    public static let Tag: String = "Alpha"
    
    /// ID of the application.
    public static let ProgramID = "3324D8E2-DF15-4A1C-B201-D6B6EF4301EF"
    ...
    public static let Build: Int = 1102
    
    /// Build increment. Value to use to increment the build number.
    private static let BuildIncrement = 1
    
    /// Build ID.
    public static let BuildID: String = "05A947C7-D19B-4990-B7DA-918D7518CDD1"
    
    /// Build date.
    public static let BuildDate: String = "4 June 2021"
    
    /// Build Time.
    public static let BuildTime: String = "18:04"
    ...
    /// Copyright years.
    public static let CopyrightYears = [2018, 2019, 2020, 2021]
