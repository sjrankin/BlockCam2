...
class Gloom: BuiltInFilterProtocol
{
    static var FilterType: BuiltInFilters = .Gloom
                   ...
                   _ ColorSpace: CGColorSpace, Options: [FilterOptions: Any]) -> CVPixelBuffer
    {
        ...
        {
            fatalError("Error getting description of buffer in Gloom.")
        }
        ...
        {
            fatalError("Error creating local buffer pool in Gloom.")
        }
        let Adjust = CIFilter.gloom()
