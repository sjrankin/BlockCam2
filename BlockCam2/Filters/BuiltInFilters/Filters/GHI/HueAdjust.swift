...
class HueAdjust: CIFilterBase, BuiltInFilterProtocol
{
    static var FilterType: BuiltInFilters = .HueAdjust
                   ...
                   _ ColorSpace: CGColorSpace, Options: [FilterOptions: Any]) -> CVPixelBuffer
    {
        ...
        Adjust.angle = Float(Options[.Angle] as? Double ?? 135.0)
    ...
    {
        Settings.SetDouble(.HueAngle,
                           Settings.SettingDefaults[.HueAngle] as! Double)
    }
}
