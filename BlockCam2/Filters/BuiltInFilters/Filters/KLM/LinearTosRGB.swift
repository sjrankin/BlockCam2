...
class LinearTosRGB: BuiltInFilterProtocol
{
    static var FilterType: BuiltInFilters = .LinearTosRGB
                   ...
                   _ ColorSpace: CGColorSpace, Options: [FilterOptions: Any]) -> CVPixelBuffer
    {
        ...
        {
            fatalError("Error getting description of buffer in LinearTosRGB.")
        }
        ...
        {
            fatalError("Error creating local buffer pool in LinearTosRGB.")
        }
