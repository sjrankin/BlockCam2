...
class MaskToAlpha: BuiltInFilterProtocol
{
    static var FilterType: BuiltInFilters = .MaskToAlpha
                   ...
                   _ ColorSpace: CGColorSpace, Options: [FilterOptions: Any]) -> CVPixelBuffer
    {
        ...
        {
            fatalError("Error getting description of buffer in MaskToAlpha.")
        }
        ...
        {
            fatalError("Error creating local buffer pool in MaskToAlpha.")
        }
        let Adjust = CIFilter.maskToAlpha()
