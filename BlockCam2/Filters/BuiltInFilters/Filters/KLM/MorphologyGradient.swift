...
class MorphologyGradient: BuiltInFilterProtocol
{
    static var FilterType: BuiltInFilters = .MorphologyGradient
                   ...
                   _ ColorSpace: CGColorSpace, Options: [FilterOptions: Any]) -> CVPixelBuffer
    {
        ...
        {
            fatalError("Error getting description of buffer in MorphologyGradient.")
        }
        ...
        {
            fatalError("Error creating local buffer pool in MorphologyGradient.")
        }
        let Adjust = CIFilter.morphologyGradient()
        Adjust.radius = Options[.Radius] as? Float ?? 5.0
