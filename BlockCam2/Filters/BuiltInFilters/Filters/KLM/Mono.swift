...
class Mono: BuiltInFilterProtocol
{
                   ...
                   _ ColorSpace: CGColorSpace, Options: [FilterOptions: Any]) -> CVPixelBuffer
    {
        ...
        {
            fatalError("Error getting description of buffer in Mono.")
        }
        ...
        {
            fatalError("Error creating local buffer pool in Mono.")
        }
        let Adjust = CIFilter.photoEffectMono()
