...
class MinimumComponent: BuiltInFilterProtocol
{
    static var FilterType: BuiltInFilters = .MinimumComponent
                   ...
                   _ ColorSpace: CGColorSpace, Options: [FilterOptions: Any]) -> CVPixelBuffer
    {
        ...
        {
            fatalError("Error getting description of buffer in MinimumComponent.")
        }
        ...
        {
            fatalError("Error creating local buffer pool in MinimumComponent.")
        }
        let Adjust = CIFilter.minimumComponent()
