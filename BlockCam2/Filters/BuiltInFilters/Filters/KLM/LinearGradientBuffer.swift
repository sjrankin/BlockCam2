...
class LinearGradient: BuiltInFilterProtocol
{
                   ...
                   _ ColorSpace: CGColorSpace, Options: [FilterOptions: Any]) -> CVPixelBuffer
    {
        ...
        {
            fatalError("Error getting description of buffer in LinearGradientBuffer.")
        }
        ...
        {
            fatalError("Error creating local buffer pool in LinearGradientBuffer.")
        }
