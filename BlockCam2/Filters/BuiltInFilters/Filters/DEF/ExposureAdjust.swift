...
class ExposureAdjust: BuiltInFilterProtocol
{
                   ...
                   _ ColorSpace: CGColorSpace, Options: [FilterOptions: Any]) -> CVPixelBuffer
    {
        ...
        {
            fatalError("Error getting description of buffer in ExposureAdjust.")
        }
        ...
        {
            fatalError("Error creating local buffer pool in ExposureAdjust.")
        }
        let Adjust = CIFilter.exposureAdjust()
        Adjust.ev = Options[.ExposureValue] as? Float ?? 0.5
