...
class LightTunnel: CIFilterBase, BuiltInFilterProtocol
{
                   ...
                   _ ColorSpace: CGColorSpace, Options: [FilterOptions: Any]) -> CVPixelBuffer
    {
        ...
        Adjust.radius = Float(Options[.Radius] as? Double ?? 100.0)
        Adjust.rotation = Float(Options[.Rotation] as? Double ?? Double(Double.pi * 8.0))
