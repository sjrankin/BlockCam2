...
class SharpenLuminance: BuiltInFilterProtocol
{
    static var FilterType: BuiltInFilters = .SharpenLuminance
                   ...
                   _ ColorSpace: CGColorSpace, Options: [FilterOptions: Any]) -> CVPixelBuffer
    {
        ...
        {
            fatalError("Error getting description of buffer in SharpenLuminance.")
        }
        ...
        {
            fatalError("Error creating local buffer pool in SharpenLuminance.")
        }
        let Adjust = CIFilter.sharpenLuminance()
