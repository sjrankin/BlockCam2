...
class Tonal: BuiltInFilterProtocol
{
    static var FilterType: BuiltInFilters = .Tonal
                   ...
                   _ ColorSpace: CGColorSpace, Options: [FilterOptions: Any]) -> CVPixelBuffer
    {
        ...
        {
            fatalError("Error getting description of buffer in Tonal.")
        }
        ...
        {
            fatalError("Error creating local buffer pool in Tonal.")
        }
        let Adjust = CIFilter.photoEffectTonal()
