...
class XRay: BuiltInFilterProtocol
{
    static var FilterType: BuiltInFilters = .XRay
                   ...
                   _ ColorSpace: CGColorSpace, Options: [FilterOptions: Any]) -> CVPixelBuffer
    {
        ...
        {
            fatalError("Error getting description of buffer in XRay.")
        }
        ...
        {
            fatalError("Error creating local buffer pool in XRay.")
        }
        let Adjust = CIFilter.xRay()
