...
class ColorInvert: BuiltInFilterProtocol
{
    static var FilterType: BuiltInFilters = .ColorInvert
                   ...
                   _ ColorSpace: CGColorSpace, Options: [FilterOptions: Any]) -> CVPixelBuffer
    {
        ...
        {
            fatalError("Error getting description of buffer in ColorInvert.")
        }
        ...
        {
            fatalError("Error creating local buffer pool in ColorInvert.")
        }
