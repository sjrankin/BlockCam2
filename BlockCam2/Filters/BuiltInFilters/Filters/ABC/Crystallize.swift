...
class Crystallize: BuiltInFilterProtocol
{
    static var FilterType: BuiltInFilters = .Crystallize 
                   ...
                   _ ColorSpace: CGColorSpace, Options: [FilterOptions: Any]) -> CVPixelBuffer
    {
        ...
        {
            fatalError("Error getting description of buffer in Crystallize.")
        }
        ...
        {
            fatalError("Error creating local buffer pool in Crystallize.")
        }
