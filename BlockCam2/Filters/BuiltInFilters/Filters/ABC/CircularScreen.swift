...
class CircularScreen: BuiltInFilterProtocol
{
    static var FilterType: BuiltInFilters = .CircularScreen
                   ...
                   _ ColorSpace: CGColorSpace, Options: [FilterOptions: Any]) -> CVPixelBuffer
    {
        ...
        {
            fatalError("Error getting description of buffer in CircularScreen.")
        }
        ...
        {
            fatalError("Error creating local buffer pool in CircularScreen.")
        }
