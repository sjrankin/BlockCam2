...
class Process: BuiltInFilterProtocol
{
    static var FilterType: BuiltInFilters = .Process
                   ...
                   _ ColorSpace: CGColorSpace, Options: [FilterOptions: Any]) -> CVPixelBuffer
    {
        ...
        {
            fatalError("Error getting description of buffer in Process.")
        }
        ...
        {
            fatalError("Error creating local buffer pool in Process.")
        }
        let Adjust = CIFilter.photoEffectProcess()
