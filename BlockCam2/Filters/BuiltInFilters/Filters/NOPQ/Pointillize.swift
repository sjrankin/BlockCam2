...
class Pointillize: BuiltInFilterProtocol
{
    static var FilterType: BuiltInFilters = .Pointillize
                   ...
                   _ ColorSpace: CGColorSpace, Options: [FilterOptions: Any]) -> CVPixelBuffer
    {
        ...
        {
            fatalError("Error getting description of buffer in Pointillize.")
        }
        ...
        {
            fatalError("Error creating local buffer pool in Pointillize.")
        }
        let Adjust = CIFilter.pointillize()
