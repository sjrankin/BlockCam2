...
class Otsu: BuiltInFilterProtocol
{
    static var FilterType: BuiltInFilters = .Otsu
                   ...
                   _ ColorSpace: CGColorSpace, Options: [FilterOptions: Any]) -> CVPixelBuffer
    {
        ...
        {
            fatalError("Error getting description of buffer in Otsu.")
        }
        ...
        {
            fatalError("Error creating local buffer pool in Otsu.")
        }
        let Adjust = CIFilter.colorThresholdOtsu()
