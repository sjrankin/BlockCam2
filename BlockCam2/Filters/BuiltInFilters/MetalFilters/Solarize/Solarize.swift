...
class Solarize: MetalFilterParent, BuiltInFilterProtocol
{
    ...
    func Initialize(With FormatDescription: CMFormatDescription, BufferCountHint: Int)
    {
        ...
        {
            print("LocalBufferPool is nil in Solarize.Initialize.")
            return
        }
        ...
        {
            fatalError("Unable to allocate texture cache in Solarize.")
        }
                   ...
                   _ ColorSpace: CGColorSpace, Options: [FilterOptions: Any]) -> CVPixelBuffer
    {
        ...
        if !Initialized
        {
            Debug.FatalError("Solarize not initialized at Render(CVPixelBuffer) call.")
        }
        
        let How = Options[.IntCommand] as! Int
        let ThresholdAllLow = Options[.ThresholdAllLow] as! Double
        let ThresholdAllHigh = Options[.ThresholdAllHigh] as! Double
        let IfGreater = Options[.IsGreater] as! Bool
        let LowHue = Options[.LowHue] as! Double
        let HighHue = Options[.HighHue] as! Double
        let BThresholdLow = Options[.BrightnessThresholdLow] as! Double
        let BThresholdHigh = Options[.BrightnessThresholdHigh] as! Double
        let SThresholdLow = Options[.SaturationThresholdLow] as! Double
        let SThresholdHigh = Options[.SaturationThresholdHigh] as! Double
        let Parameter = SolarizeParameters(SolarizeHow: simd_uint1(How),
                                           LowThreshold: simd_float1(ThresholdAllLow),
                                           HighThreshold: simd_float1(ThresholdAllHigh),
                                           LowHue: simd_float1(LowHue),
                                           HighHue: simd_float1(HighHue),
                                           BrightnessThresholdLow: simd_float1(BThresholdLow),
                                           BrightnessThresholdHigh: simd_float1(BThresholdHigh),
                                           SaturationThresholdLow: simd_float1(SThresholdLow),
                                           SaturationThresholdHigh: simd_float1(SThresholdHigh),
