...
/// Returns the absolute value of the delta of each pixel (on a channel-by-channel basis) if _any_ channel
/// in the two pixels is different. Otherwise, transparent black is returned.
