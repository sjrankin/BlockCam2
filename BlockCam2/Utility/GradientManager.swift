...
//  BlockCam2
//  Adapted from BumpCamera, 3/6/19.
//
...
class GradientManager
{
    ...
    private static let KnownColors: [String: UIColor] =
        [
            ...
            "indigo": UIColor(RGB: 0x3f00ff),
            "violet": UIColor(RGB: 0x7f00ff),
            "coral": UIColor(RGB: 0xff7e50),
            "gold": UIColor(RGB: 0xffd700),
            "mauve": UIColor(RGB: 0xb784a7),
            "pastelbrown": UIColor(RGB: 0x836953),
            "pistachio": UIColor(RGB: 0x93c572),
            "tomato": UIColor(RGB: 0xff6347),
            "pink": UIColor(RGB: 0xffc0cb),
            "pastelyellow": UIColor(RGB: 0xfdfd96),
            "saffron": UIColor(RGB: 0xf4c430),
            "magicmint": UIColor(RGB: 0xaaf0d1),
            "yellowprocess": UIColor(RGB: 0xffef00),
            "thistle": UIColor(RGB: 0xd8bfd8),
            "honeydew": UIColor(RGB: 0xf0fff0),
            "lavender": UIColor(RGB: 0xe6e6fa),
            "mustard": UIColor(RGB: 0xffdb58),
            "babyblue": UIColor(RGB: 0x89cff0),
            "chartreuse": UIColor(RGB: 0xdfff00),
            "atomictangerine": UIColor(RGB: 0xff9966),
            "daffodil": UIColor(RGB: 0xffff31),
            "mistyrose": UIColor(RGB: 0xffe4e1),
            "greenpastel": UIColor(RGB: 0xbaed91),
            "pastelpink": UIColor(RGB: 0xffd1dc)
        ]
